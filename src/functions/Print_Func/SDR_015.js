    ...
    create_table_body_data(data) {
        ...
        for(let i=0; i<data.length; i++) {
            result +=   ''
                    ...
                    +       '<td style="width: 20%; border: 1px solid #000000;">' + data[i].product_name + '</td>'
                    ...
                    +       '<td style="text-align: right; border: 1px solid #000000;">' + data[i].unit_price_TP_SP + '</td>'
                    +       '<td style="text-align: right; border: 1px solid #000000;">' + data[i].unit_VAT + '</td>'
                    +       '<td style="text-align: right; border: 1px solid #000000;">' + data[i].unit_price_with_VAT + '</td>'
                    +       '<td style="border: 1px solid #000000;">' + data[i].qty + '</td>'
                    +       '<td style="border: 1px solid #000000;">' + data[i].bonus + '</td>'
                    +       '<td style="text-align: right; border: 1px solid #000000;">' + data[i].total_VAT + '</td>'
                    +       '<td style="text-align: right; border: 1px solid #000000;">' + data[i].total_TP_SP + '</td>'
                    +   '</tr>'
        }
