...
function () {
  ...
  _createClass(PP_Invoice_Type_2_Single, [{
    ...
    value: function addStylePrint_3() {
      ...
      + 'margin: 10mm 10mm 15mm 15mm; border: 1px solid #000000' + '}' + +'@media print {' + 'body {' + 'margin: 0px;' //   +         'font-family: "Courier";'
    ...
    value: function create_gross_TP_data(data) {
      ...
      var gross_tp = '';
      gross_tp += '' + '<tr style=" "><td colspan="13"><hr /></td></tr>' + '<tr style=" ">' + '<td colspan="9" style="margin-top: 10px; >' + '<p style="text-align: left; margin: 0;">In Word : ' + this.convert_number_to_word(Number(NET_PAYABLE_AFTER_ADJ).toFixed(0)) + '.</p>' + '</td>' + '<td colspan="2" style="text-align: right; margin-top: 10px;>' + 'Gross TP :' + '</td>' + '<td style="text-align: right; margin-top: 10px; border-bottom: 1px solid #000000;">' + '' + '</td>' + '<td style="text-align: right; margin-top: 10px; border-bottom: 1px solid #000000;">' + comaSeparatedDigits.comaSeparate(data.inv_tp) + '</td>' + '</tr>';
      return gross_tp;
    }
  }, {
    ...
    value: function create_discount_data(data) {
      var discount = '';
      discount += '' + '<tr>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td colspan="5" style="text-align: right;">' + 'Less discount on TP :' + '</td>' + '<td style="text-align: right; border-bottom: 1px solid #000000;">' + '' + '</td>' + '<td style="text-align: right; border-bottom: 1px solid #000000;">' + comaSeparatedDigits.comaSeparate(data.inv_discount) + '</td>' + '</tr>';
      return discount;
    }
  }, {
    key: "create_vat_data",
    value: function create_vat_data(data) {
      var vat = '';
      vat += '' + '<tr>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td colspan="5" style="text-align: right;">' + 'Add VAT on TP :' + '</td>' + '<td style="text-align: right; border-bottom: 1px solid #000000;">' + '' + '</td>' + '<td style="text-align: right; border-bottom: 1px solid #000000;">' + comaSeparatedDigits.comaSeparate(data.inv_vat) + '</td>' + '</tr>';
      return vat;
    }
  }, {
    ...
    value: function create_rounding_adjustment_data() {
      ...
      if (ROUNDING_ADJ !== 0) {
        rounding_adjustment += '' + '<tr>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td colspan="5" style="text-align: right;">' + 'Rounding Adjustment :' + '</td>' + '<td style="text-align: right; border-bottom: 1px solid #000000;">' + '' + '</td>' + '<td style="text-align: right; border-bottom: 1px solid #000000;">' + ROUNDING_ADJ + '</td>' + '</tr>';
      }
    ...
    value: function create_net_payable_data() {
      var net_payable = '';
      net_payable += '' + '<tr>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td>' + '' + '</td>' + '<td colspan="5" style="text-align: right;">' + 'Net Payable :' + '</td>' + '<td style="text-align: right; border-bottom: 1px solid #000000;">' + '' + '</td>' + '<td style="text-align: right; border-bottom: 1px solid #000000;">' + comaSeparatedDigits.comaSeparate(NET_PAYABLE_AFTER_ADJ) + '.00</td>' + '</tr>';
      return net_payable;
    }
  }, {
    ...
    value: function create_signature_section() {
      var result = '';
      result += '' + '<div class="signature-section" style="float: right; page-break-after: always; page-break-inside: avoid; margin-top: 60px; font-size: 12px;">' + '<p style="margin: 0; text-align: center; font-family: calibri; "><span style="border-bottom: 1px solid #000000; width: 300px; display: block;">FAYAZUR RAHMAN SUMMIT</span><span style="width: 300px; display: block;">For NIPRO JMI Pharma Ltd.</span></p>' + '</div>';
      return result;
    }
  }, {
