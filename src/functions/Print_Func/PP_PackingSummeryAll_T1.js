...
export default class PP_InvoiceChallanSummeryTD_Type1 {
    ...
    print_invoice(table_header, table_data, summery) {
        ...
        mywindow.document.write(''
                            ...
                            +                         '<tr style="">'
                            +                             '<td colspan="6" style="">'
                            +                                 '<p style="display: inline-block; float: left;"><span class="label">No. of Invoices</span><span class="label-value">: ' + (summery.invoice_count ? (summery.invoice_count) : '') + '</span></p>'
                            +                             '</td>'
                            +                         '</tr>'
                            +                         '<tr style="">'
                            +                             '<td colspan="6" style="">'
                            +                                 '<p style="display: inline-block; float: right;"><span class="label">Depot</span><span class="label-value">: ' + (summery.depo_name ? (summery.depo_name) : '') + '</span></p>'
                            +                             '</td>'
                            +                         '</tr>'
                            +                         '<tr style="">'
                            +                             '<td colspan="6" style="">'
                            +                                 '<p style="display: inline-block; float: left;"><span class="label">DS No</span><span class="label-value">: ' + (summery.ds_no ? (summery.ds_no) : '') + '</span></p>'
