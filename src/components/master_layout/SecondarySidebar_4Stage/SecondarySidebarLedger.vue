...
export default {
  ...
  methods: {
    ...
    primaryArrowClick(i) {
      ...
      let secondaryAreaSection = document.querySelector("#secondary-sidebar-ledger #primary-area-" + i + " .secondary-area-section")
      let primaryDownArrow = document.querySelector("#secondary-sidebar-ledger #primary-area-" + i + " #primary-down-arrow-" + i)
      let primaryRightArrow = document.querySelector("#secondary-sidebar-ledger #primary-area-" + i + " #primary-right-arrow-" + i)
      let primaryName = document.querySelector("#secondary-sidebar-ledger #primary-area-" + i + " .primary-name")
    ...
    secondaryArrowClick(i, j) {
      let tertiaryAreaSection = document.querySelector("#secondary-sidebar-ledger #primary-area-" + i + " #secondary-area-" + i + "-" + j + " .tertiary-area-section")
      let primaryDownArrow = document.querySelector("#secondary-sidebar-ledger #primary-area-" + i + " #secondary-area-" + i + "-" + j + " #secondary-down-arrow-" + i + "-" + j)
      let primaryRightArrow = document.querySelector("#secondary-sidebar-ledger #primary-area-" + i + " #secondary-area-" + i + "-" + j + " #secondary-right-arrow-" + i + "-" + j)
      let secondaryName = document.querySelector("#secondary-sidebar-ledger #primary-area-" + i + " #secondary-area-" + i + "-" + j + " .secondary-name")
      if(document.querySelector('#secondary-sidebar-ledger #secondary-area-section-' + i + ' #tertiary-area-section-' + i + '-' + j).className === "tertiary-area-section") {
        document.querySelector('#secondary-sidebar-ledger #secondary-area-section-' + i + ' #tertiary-area-section-' + i + '-' + j).className = "tertiary-area-section hide"
    ...
    tertiaryClick(i, j, k) {
      ...
      let tertiary_right_arrow = document.querySelector('#secondary-sidebar-ledger #tertiary-right-arrow-' + i + '-' + j + '-' + k)
      let tertiary_down_arrow = document.querySelector('#secondary-sidebar-ledger #tertiary-down-arrow-' + i + '-' + j + '-' + k)
      let tertiary_name = document.querySelector('#secondary-sidebar-ledger #tertiary-name-' + i + '-' + j + '-' + k)
      if(document.querySelector('#secondary-sidebar-ledger #poly-tertiary-area-section-' + i + '-' + j + '-' + k).className === "poly-tertiary-area-section") {
        document.querySelector('#secondary-sidebar-ledger #poly-tertiary-area-section-' + i + '-' + j + '-' + k).className = "poly-tertiary-area-section hide"

            tertiary_name.className = 'tertiary-name'
          tertiary_down_arrow.className = 'hide'
          tertiary_right_arrow.className = ''
      } else {
          document.querySelector('#secondary-sidebar-ledger #poly-tertiary-area-section-' + i + '-' + j + '-' + k).className = "poly-tertiary-area-section"
    ...
    polyTertiaryClick(i, j, k, l) {
      ...
      for(let i=0; i<document.querySelectorAll('#secondary-sidebar-ledger .poly-tertiary-name').length; i++) {
          document.querySelectorAll('#secondary-sidebar-ledger .poly-tertiary-name')[i].className = 'poly-tertiary-name'
          document.querySelectorAll('#secondary-sidebar-ledger .square-icon')[i].className = 'square-icon'
      }
