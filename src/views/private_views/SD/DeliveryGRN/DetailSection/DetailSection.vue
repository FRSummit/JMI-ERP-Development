                  ...
                  <v-tabs-items v-model="tab" class="tab-container" style="">
                    <v-tab-item v-for="(status, i) in status_list" :key="i">
                      <v-card color="basil" flat>
                        <v-card v-if="status.status_name === 'Institution'"><DetailsDataList :tab="status.status_name" :SCHEDULE_DETAILS_LIST="SCHEDULE_DETAILS_LIST_CHEMIST" :HEADER_DATA="HEADER_DATA" /></v-card>
