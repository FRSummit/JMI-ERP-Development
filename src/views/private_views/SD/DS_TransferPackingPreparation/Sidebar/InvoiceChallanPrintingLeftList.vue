      ...
      <div class="invoice-challan-printing-list-section-inner">
        ...
        <div class="location-title">
          <div class="location-title-inner">
            <p>Stock Transfer List (<span>{{ STOCK_TRANSFER_PACKING_PREPARATION ? STOCK_TRANSFER_PACKING_PREPARATION.length : 0 }}</span>)</p>
          </div>
        </div>
        <div class="location-list-section">
          <div class="location-list-section-inner">
            <div
              ...
              v-for="(invoice, p) in STOCK_TRANSFER_PACKING_PREPARATION"
              :key="p"
              ...
              <div class="invoice-challan-printing-section-list-inner">
                <div class="name-status-section">
                  <div class="name-section">
                    <p class="name-text">{{ invoice.requisition_no }}</p>
                  </div>
                  <div class="status-section">
                    <p class="status-text">
                      {{ dateFormate(invoice.req_date) }}
                    </p>
                  </div>
                </div>
...
export default {
  props: ["STOCK_TRANSFER_PACKING_PREPARATION"],
  components: {
    // HotelDatePicker,
    // DatePicker
  },
