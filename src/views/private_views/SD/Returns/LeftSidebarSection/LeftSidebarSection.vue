      ...
      <div class="deliveries-left-sidebar-section-inner">
        ...
        <div class="customer-list-section">
            <div class="customer-list-section-inner">
                ...
                <div :id="'customer-section-list-' + c" class="customer-section-list" v-for="(ss, c) in ALL_LEFT_SIDEBAR_LIST" :key="c" @click="customerClickHandlerFromList(customer, c)">
                        ...
                        <div class="customer-name-section">
                            <div class="customer-name-section-inner">
                                <div class="name-section">
                                    <p class="customer-name">{{ ss.name }}</p>
                                </div>
                        ...
                        <div class="customer-address-section">
                            <div class="customer-address-section-inner">
                                <div class="address-section">
                                    <p class="customer-address">{{ ss.address }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default {
    ...
    data() {
        return {
            ALL_LEFT_SIDEBAR_LIST: [
                {dusplay_code: "JMI-2231225", c_type: "Credit", name: "New Vai Vai Pharmacy", address: "House: 100, Road: 200, Dhaka"},
                {dusplay_code: "JMI-2231225", c_type: "Credit", name: "New Vai Vai Pharmacy", address: "House: 100, Road: 200, Dhaka"},
                {dusplay_code: "JMI-2231225", c_type: "Credit", name: "New Vai Vai Pharmacy", address: "House: 100, Road: 200, Dhaka"},
                {dusplay_code: "JMI-2231225", c_type: "Credit", name: "New Vai Vai Pharmacy", address: "House: 100, Road: 200, Dhaka"},
                {dusplay_code: "JMI-2231225", c_type: "Credit", name: "New Vai Vai Pharmacy", address: "House: 100, Road: 200, Dhaka"},
