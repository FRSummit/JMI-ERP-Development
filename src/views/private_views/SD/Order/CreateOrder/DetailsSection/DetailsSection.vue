                                    ...
                                    <div class="response-body">
                                        ...
                                        <tr class="responer-body-filter-output" v-for="(data, i) in auto_field_data" :key="i">
                                            <td>
                                                ...
                                                <span class="responer-body-filter-tag-id">Code: {{ data ? (data.display_code ? data.display_code : data.prod_id) : "" }} {{ data ? (data.offer ? ('| ' + data.offer) : '') : "" }}<span class="responer-body-filter-tag-id" style="display: inline-block; margin-left: 2px;"> | ID: {{ data ? (data.prod_id ? (data.prod_id) : '') : "" }}</span></span>
                                            </td>
                                            <td>
