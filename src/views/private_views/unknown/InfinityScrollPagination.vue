...
export default {
    ...
    methods: {
        ...
        getInitialUsers() {
            ...
            // axios.get(`https://203.188.245.58:8885/api/web/all-customers-for-depot/?results=5`).then((response) => {
        ...
        getNextUser() {
            window.onscroll = () => {
                ...
                if (bottomOfWindow) {
                    ...
                    // axios.get(`https://203.188.245.58:8885/api/web/all-customers-for-depot/`).then(response => {
